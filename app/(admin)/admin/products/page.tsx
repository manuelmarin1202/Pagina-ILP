...
// URL BASE DEL STORAGE (Para evitar repetir código)
...
export default async function AdminProductsPage() {
  ...
  // --- CONSULTA CORREGIDA ---
  // 1. Quitamos 'product_images' que ya no se usa.
  // 2. Traemos 'image_path' directamente de products.
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        ...
        <Link 
          href="/admin/products/new" // Asegúrate que la ruta sea correcta (dashboard o admin)
          ...
          <table className="w-full text-left text-sm text-gray-600">
            <thead className="bg-gray-50 text-gray-900 font-bold uppercase text-xs">
              <tr>
                ...
                <th className="px-6 py-4 text-center">Slug (URL)</th>
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="relative w-12 h-12 rounded-lg overflow-hidden border border-gray-200 bg-gray-100 flex items-center justify-center">
                        {imgUrl ? (
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                        {/* @ts-ignore */}
                        {product.categories?.name || "Sin Cat."}
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4 text-right flex justify-end gap-4 items-center h-full mt-3">
                      ...
                      <DeleteButton id={product.id} table="products" />
                    </td>
                  </tr>
                )
              })}
